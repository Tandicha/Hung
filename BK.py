...
with open("D:\Kuliah\Bimbingan Karir\Bimbingan Karir Minggu 3\hungarian.data", encoding='Latin1') as file:
...
model = pickle.load(open("D:\Kuliah\Bimbingan Karir\Bimbingan Karir Minggu 3\modelXGB.pkl", 'rb'))
